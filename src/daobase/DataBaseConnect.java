...
public class DataBaseConnect {
    ...
    static String url = "jdbc:mysql://120.78.144.47:3306/decorate?user=root&password=sj@123456";
    ...
    public List<Object> paginate(String table, int start, int rows, String model_class){
        ...
        String sql = String.format("select * from %s limit %d , %d", table, start, rows);
    ...
    public List<Object> paginate(String table, int start, int rows, String column, String _sql, String model_class){
        String sql = String.format("select * from %s where %s %s limit %d, %d", table, column, _sql, start, rows);
        return this.query_filter(sql, model_class);
