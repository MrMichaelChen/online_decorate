...
<s:form action='updateuser' method='post'>
    <s:textfield name='user.id' label='用户编号' requiredLabel='true' requiredPosition='left'/>
    ...
    <s:textfield name='user.role' label='角色' requiredLabel='true' requiredPosition='left'/>
    <s:submit value="更新"/>
</s:form>
</body>
</html>
